...
config :web_analytics, WebAnalyticsWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "byrkxQOKdCZril8IJqCz7ENbglwYVKUMtS4HSNkBnoPffCyvZOcIltl2Ph5Z2b34",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:web_analytics, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:web_analytics, ~w(--watch)]}
  ]
...
config :web_analytics, dev_routes: true
